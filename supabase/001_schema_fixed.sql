...
create policy "Allow all for users_restaurants" on users_restaurants for all using (true) with check (true);
create policy "Allow all for tables" on tables for all using (true) with check (true);
create policy "Allow all for waitlists" on waitlists for all using (true) with check (true);
create policy "Allow all for parties" on parties for all using (true) with check (true);
create policy "Allow all for notifications" on notifications for all using (true) with check (true);
create policy "Allow all for metrics_daily" on metrics_daily for all using (true) with check (true);
