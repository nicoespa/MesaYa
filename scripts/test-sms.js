 ...
 * 
 * This script tests the SMS provider to ensure it's working correctly.
...
async function testSMS() {
  ...
  try {
    ...
    const { SMSProvider } = await import('../lib/messaging/sms.js');
